...
COPY part FROM '/Users/Shared/tpch_0_001/part.cpy' WITH CSV DELIMITER '|';       
COPY supplier FROM '/Users/Shared/tpch_0_001/supplier.cpy' WITH CSV DELIMITER '|';       
COPY partsupp FROM '/Users/Shared/tpch_0_001/partsupp.cpy' WITH CSV DELIMITER '|';      
COPY customer FROM '/Users/Shared/tpch_0_001/customer.cpy' WITH CSV DELIMITER '|';       
COPY orders FROM '/Users/Shared/tpch_0_001/orders.cpy' WITH CSV DELIMITER '|';       
COPY lineitem FROM '/Users/Shared/tpch_0_001/lineitem.cpy' WITH CSV DELIMITER '|';       
COPY nation FROM '/Users/Shared/tpch_0_001/nation.cpy' WITH CSV DELIMITER '|';
COPY region FROM '/Users/Shared/tpch_0_001/region.cpy' WITH CSV DELIMITER '|';
