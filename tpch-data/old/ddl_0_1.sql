...
COPY part FROM '/Users/Shared/tpch_0_1/part.cpy' WITH CSV DELIMITER '|';       
COPY supplier FROM '/Users/Shared/tpch_0_1/supplier.cpy' WITH CSV DELIMITER '|';       
COPY partsupp FROM '/Users/Shared/tpch_0_1/partsupp.cpy' WITH CSV DELIMITER '|';      
COPY customer FROM '/Users/Shared/tpch_0_1/customer.cpy' WITH CSV DELIMITER '|';       
COPY orders FROM '/Users/Shared/tpch_0_1/orders.cpy' WITH CSV DELIMITER '|';       
COPY lineitem FROM '/Users/Shared/tpch_0_1/lineitem.cpy' WITH CSV DELIMITER '|';       
COPY nation FROM '/Users/Shared/tpch_0_1/nation.cpy' WITH CSV DELIMITER '|';
COPY region FROM '/Users/Shared/tpch_0_1/region.cpy' WITH CSV DELIMITER '|';
