...
COPY part FROM '/home/quanpt/assi/perm/tpch/scriptsAndData/data/tpch_0_001/part.cpy' WITH CSV DELIMITER '|';       
COPY supplier FROM '/home/quanpt/assi/perm/tpch/scriptsAndData/data/tpch_0_001/supplier.cpy' WITH CSV DELIMITER '|';       
COPY partsupp FROM '/home/quanpt/assi/perm/tpch/scriptsAndData/data/tpch_0_001/partsupp.cpy' WITH CSV DELIMITER '|';      
COPY customer FROM '/home/quanpt/assi/perm/tpch/scriptsAndData/data/tpch_0_001/customer.cpy' WITH CSV DELIMITER '|';       
COPY orders FROM '/home/quanpt/assi/perm/tpch/scriptsAndData/data/tpch_0_001/orders.cpy' WITH CSV DELIMITER '|';       
COPY nation FROM '/home/quanpt/assi/perm/tpch/scriptsAndData/data/tpch_0_001/nation.cpy' WITH CSV DELIMITER '|';
COPY region FROM '/home/quanpt/assi/perm/tpch/scriptsAndData/data/tpch_0_001/region.cpy' WITH CSV DELIMITER '|';
...
COPY lineitem1 FROM '/home/quanpt/assi/perm/tpch/scriptsAndData/data/tpch_0_001/lineitem.cpy' WITH CSV DELIMITER '|';       
...
COPY lineitem2 FROM '/home/quanpt/assi/perm/tpch/scriptsAndData/data/tpch_0_001/lineitem.cpy' WITH CSV DELIMITER '|';       
...
COPY lineitem3 FROM '/home/quanpt/assi/perm/tpch/scriptsAndData/data/tpch_0_001/lineitem.cpy' WITH CSV DELIMITER '|';       
...
COPY lineitem4 FROM '/home/quanpt/assi/perm/tpch/scriptsAndData/data/tpch_0_001/lineitem.cpy' WITH CSV DELIMITER '|';       
...
COPY lineitem5 FROM '/home/quanpt/assi/perm/tpch/scriptsAndData/data/tpch_0_001/lineitem.cpy' WITH CSV DELIMITER '|';       
...
COPY lineitem6 FROM '/home/quanpt/assi/perm/tpch/scriptsAndData/data/tpch_0_001/lineitem.cpy' WITH CSV DELIMITER '|';       
...
COPY lineitem7 FROM '/home/quanpt/assi/perm/tpch/scriptsAndData/data/tpch_0_001/lineitem.cpy' WITH CSV DELIMITER '|';       
...
COPY lineitem8 FROM '/home/quanpt/assi/perm/tpch/scriptsAndData/data/tpch_0_001/lineitem.cpy' WITH CSV DELIMITER '|';       
...
COPY lineitem9 FROM '/home/quanpt/assi/perm/tpch/scriptsAndData/data/tpch_0_001/lineitem.cpy' WITH CSV DELIMITER '|';       
...
DROP TABLE IF EXISTS lineitem10 CASCADE;

DROP INDEX IF EXISTS fkey_line1_10 CASCADE;
DROP INDEX IF EXISTS fkey_line2_10 CASCADE;
DROP INDEX IF EXISTS fkey_line3_10 CASCADE;
DROP INDEX IF EXISTS fkey_line4_10 CASCADE;

CREATE TABLE lineitem10 (
	l_orderkey	INT8,
	l_partkey	INT8,
	l_suppkey	INT8,
	l_linenumber	INT8,
...
COPY lineitem10 FROM '/home/quanpt/assi/perm/tpch/scriptsAndData/data/tpch_0_001/lineitem.cpy' WITH CSV DELIMITER '|';       

ALTER TABLE lineitem10 ADD FOREIGN KEY (l_partkey, l_suppkey) REFERENCES partsupp (ps_partkey, ps_suppkey);
ALTER TABLE lineitem10 ADD FOREIGN KEY (l_partkey) REFERENCES part (p_partkey);
ALTER TABLE lineitem10 ADD FOREIGN KEY (l_suppkey) REFERENCES supplier (s_suppkey);
ALTER TABLE lineitem10 ADD FOREIGN KEY (l_orderkey) REFERENCES orders (o_orderkey);

CREATE INDEX fkey_line1_10 ON lineitem10 (l_orderkey);
CREATE INDEX fkey_line2_10 ON lineitem10 (l_partkey, l_suppkey);
CREATE INDEX fkey_line3_10 ON lineitem10 (l_partkey);
CREATE INDEX fkey_line4_10 ON lineitem10 (l_suppkey);
